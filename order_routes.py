...
order_router=APIRouter(
    ...
    tags=['orders']         # Tag for grouping related routes in the documentation
)
...
# A sample hello world route, This returns Hello world
@order_router.get('/')
...
# Placing an Order, This requires the following
#                    - quantity : integer
#                    - pizza_size: str
...
# List all orders
# This lists all  orders made. It can be accessed by superusers only
        
@order_router.get('/orders')
async def list_all_orders(Authorize:AuthJWT=Depends()):

    '''List all orders, This lists all  orders made. It can be accessed by Superusers only.'''
...
async def update_order_status(
    ...
    """Update an order's status. This is for updating an order's status and requires ` order_status ` in str format."""
...
# Delete an Order. This deletes an order by its ID.
